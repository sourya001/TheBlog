  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      <div className="container mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-center mb-6">Welcome to Our Blog</h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <Link to="/blog/post-1" className="text-blue-600 hover:text-blue-800">Read more</Link>
          </div>
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <Link to="/blog/post-2" className="text-blue-600 hover:text-blue-800">Read more</Link>
          </div>
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <Link to="/blog/post-3" className="text-blue-600 hover:text-blue-800">Read more</Link>
          </div>
        </div>
      </div>
    </div>
